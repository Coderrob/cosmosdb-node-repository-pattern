...
module.exports = class CosmosDbRepository {
    ...
    getById(id) {
        return new Promise((resolve, reject) => {
            ...
            this.client.readDocument(uriFactory.createDocumentUri(this.databaseId, this.collectionId, id), (err, result) => {
        ...
        return new Promise((resolve, reject) => {
            ...
            this.getById(id)
                .then((document) => {
                    ...
                    this.client.deleteDocument(uriFactory.createDocumentUri(this.databaseId, this.collectionId, document.id), (err, result) => {
                        if (err) reject(err);
                        else resolve(result);
                    });
                })
    ...
    find(querySpec) {
        return new Promise((resolve, reject) => {
            ...
            this.client
                .queryDocuments(uriFactory.createDocumentCollectionUri(this.databaseId, this.collectionId), querySpec)
                .toArray((err, results) => {
                    if (err) reject(err);
        ...
        return new Promise((resolve, reject) => {
            ...
            this.getById(document.id)
                .then((result) => {
                    ...
                    this.client.createDocument(uriFactory.createDocumentCollectionUri(this.databaseId, this.collectionId), document, options, (err, created) => {
                        if (err) reject(err);
